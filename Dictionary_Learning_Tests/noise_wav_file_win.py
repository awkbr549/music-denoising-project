...
f_crackle = open(6:sys.argv[1].index(".wav")] + "_crackle_" + sys.argv[2][:sys.argv[2].index(".")] + "_" + sys.argv[2][sys.argv[2].index(".")+1:] + ".wav", "wb")
f_white = open(6:sys.argv[1].index(".wav")] + "_white_noise_" + sys.argv[3] + ".wav", "wb")
f_both = open(6:sys.argv[1].index(".wav")] + "_crackle_" + sys.argv[2][:sys.argv[2].index(".")] + "_white_noise" + sys.argv[2][sys.argv[2].index(".")+1:] + "_" + sys.argv[3] + ".wav", "wb")
